...
public class GameConfig {
    ...
    public static final HoverObject[] HOVER_OBJECTS = {
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "gym.png", "ยิม", 484.0, 172.0, 279.0, 243.0, 0.0, 659.0, 286.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "laundry.png", "ร้านซักรีด", 371.0, 245.0, 217.0, 244.0, 0.0, 512.0, 401.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "kfb.png", "ร้านไก่ทอดฟาสต์ฟู้ด", 202.0, 269.0, 234.0, 234.0, 0.0,300.0, 480.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "shop.png", "ร้านขายของชำ", 388.0, 441.0, 311.0, 343.0, 0.0, 502.0, 547.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "dormitory.png", "หอพัก", 848.0, 118.0, 218.0, 287.0, 0.0, 987.0, 329.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "bank.png", "ธนาคาร", 1464.0, 258.0, 269.0, 323.0, 0.0, 1568.0, 357.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "collectibles.png", "ร้านของสะสม", 1010.0, 290.0, 268.0, 284.0, 0.0, 1108.0, 377.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "garden.png", "สวนจก", 605.0, 402.0, 525.0, 283.0, 0.0, 833.0, 491.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "university.png", "มหาวิทยาลัย", 967.0, 597.0, 266.0, 302.0, 0.0, 1063.0, 710.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "job.png", "ศูนย์จัดหางาน", 671.0, 571.0, 240.0, 314.0, 0.0, 764.0, 677.0, "FRONT"),

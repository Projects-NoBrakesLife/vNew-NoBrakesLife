...
public class GameConfig {
    ...
    // ===== เสียงเอฟเฟค =====
    public static final String BACKGROUND_IMAGE = "assets" + java.io.File.separator + "background"
            + java.io.File.separator + "NewTimesMapMock4a.png";
    public static final String HOVER_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Button Select.wav"; // เสียงเวลา hover ปุ่ม
    public static final String TURN_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Bubble Pop.wav"; // เสียงเปลี่ยนเทิร์น
    public static final String FOOD_EATEN_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Food Eaten.wav"; // เสียงกินอาหาร
    public static final String LOCATION_OPEN_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Location Open.wav"; // เสียงเปิด popup
    public static final String LOCATION_CLOSE_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Location Close.wav"; // เสียงปิด popup
    public static final String CELEBRATION_MUSIC = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "CRAPPY_HOME_AMB.wav";
    public static final String LAST_TURN_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Last Turn.wav"; // เสียงเทิร์นสุดท้าย
    public static final String SCORE_FILL_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Score Fill.wav"; // เสียงนับคะแนน
    public static final String SCORE_TYPE_ANNOUNCED_SOUND = "assets" + java.io.File.separator + "sfx"
            + java.io.File.separator + "Score Type Announced.wav"; // เสียงประกาศผู้ชนะ
    public static final String BUTTON_CLICK_2_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Button Click 2.wav"; // เสียงคลิกปุ่ม
    public static final String HOOK_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "hook.wav"; // เสียงตกปลา
    public static final String STAMP_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "Stamp.wav"; // เสียงส่งคำตอบ
    public static final String ZZZ_SOUND = "assets" + java.io.File.separator + "sfx" + java.io.File.separator
            + "zzz.wav"; // เสียงนอน
    ...
    public static final int MAX_TURNS = 5; // จำนวนเทิร์นทั้งหมด (สัปดาห์)
    ...
    public static final Fish[] FISHES = {
            new Fish("ปลาธรรมดา",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Fish-Basic.png",
                    2, 20, 30.0),
            new Fish("ปลาสวยงาม",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Fish-Nice.png",
                    3, 40, 25.0),
            new Fish("ปลากบ",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Fish-Frog.png",
                    3, 30, 20.0),
            new Fish("ปลาพิเศษ",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Fish-Special.png",
                    3, 60, 15.0),
            new Fish("ปลาน่ากลัว",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Fish-Scary.png",
                    2, 10, 35.0),
            new Fish("Blobfish",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Special-Blobfish.png",
                    2, 100, 5.0),
            new Fish("ปลาหมึก",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Special-Octopus.png",
                    2, 80, 8.0),
            new Fish("ปลาคาร์พ",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Special-Koi.png",
                    3, 90, 7.0),
            new Fish("ปลาดาว",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Special-Starfish.png",
                    3, 70, 10.0),
            new Fish("ขวด",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Trash-Bottle.png",
                    2, 0, 40.0),
            new Fish("รองเท้าบูท",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Trash-Boot.png",
                    2, 0, 35.0),
            new Fish("ถุงขยะ",
                    "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs" + java.io.File.separator
                            + "Icon-Fishing-Trash-Bag.png",
                    2, 0, 30.0),
    };

    // ===== สถานที่ในเกม (ภาพ, ชื่อ, ตำแหน่ง, ตำแหน่งผู้เล่น) =====
    public static final HoverObject[] HOVER_OBJECTS = {
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "gym.png", "ยิมหน้ามอ",
                    484.0, 201.0, 279.0, 243.0, 0.0, 697.0, 435.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "kfb.png",
                    "ร้านไก่ทอดตลาดน้อย", 202.0, 298.0, 234.0, 234.0, 0.0, 366.0, 576.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "dormitory.png",
                    "หอพัก", 848.0, 147.0, 218.0, 287.0, 0.0, 980.0, 435.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "bank.png",
                    "ธนาคารไทณิชย์", 1464.0, 287.0, 269.0, 323.0, 0.0, 1508.0, 585.0, "BACK"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "garden.png", "สวนจก",
                    605.0, 431.0, 525.0, 283.0, 0.0, 874.0, 567.0, "FRONT"),
            new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "university.png",
                    "มหาวิทยาลัย NSU", 967.0, 626.0, 266.0, 302.0, 0.0, 1026.0, 899.01, "FRONT"),
    ...
    public static class HoverObject {
        ...
        public HoverObject(String imagePath, String name, double x, double y, double width, double height,
                double rotation, double playerX, double playerY, String direction) {

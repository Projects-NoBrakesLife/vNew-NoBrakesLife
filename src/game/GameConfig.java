...
public class GameConfig {
        ...
        public static final String LOCATION_OPEN_SOUND = "assets" + java.io.File.separator + "sfx"
                        + java.io.File.separator
                        + "Location Open.wav"; // เสียงเปิด popup
        public static final String LOCATION_CLOSE_SOUND = "assets" + java.io.File.separator + "sfx"
                        + java.io.File.separator
                        + "Location Close.wav"; // เสียงปิด popup
        public static final String CELEBRATION_MUSIC = "assets" + java.io.File.separator + "sfx"
                        + java.io.File.separator
                        + "CRAPPY_HOME_AMB.wav";
        ...
        public static final String BUTTON_CLICK_2_SOUND = "assets" + java.io.File.separator + "sfx"
                        + java.io.File.separator
        ...
        public static final Fish[] FISHES = {
                        new Fish("ปลาธรรมดา",
                                        "assets" + java.io.File.separator + "ui" + java.io.File.separator + "fishs"
                                                        + java.io.File.separator
        ...
        public static final HoverObject[] HOVER_OBJECTS = {
                        new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator + "gym.png",
                                        "ยิมหน้ามอ",
                        ...
                        new HoverObject("assets" + java.io.File.separator + "obj" + java.io.File.separator
                                        + "dormitory.png",

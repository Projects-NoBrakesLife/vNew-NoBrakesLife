...
public class GameEditor extends JFrame {
    private GameEditorPanel editorPanel;
    ...
    private void initializeWindow() {
        setTitle("Game HUD Editor - No Brakes Life");
    ...
    private void createEditorPanel() {
        editorPanel = new GameEditorPanel();
    ...
    private class GameEditorPanel extends JPanel implements MouseListener, MouseMotionListener {
        ...
        private void loadBackgroundImage() {
            try {
                String fullPath = System.getProperty("user.dir") + File.separator +
                        "assets" + File.separator + "background" + File.separator + "NewTimesMapMock4a.png";
        ...
        private void setupToolbar() {
            ...
            addTextBtn.addActionListener(_ -> {
                handleAddText();
            });
            ...
            loadFromGameBtn.addActionListener(_ -> {
                loadFromGame();
            });
            ...
            scaleSlider.addChangeListener(_ -> {
                handleScaleChange();
            });
            ...
            fontSlider.addChangeListener(_ -> {
                handleFontChange();
            });
        ...
        private void handleExportCode() {
            ...
            code.append("public static void loadGameElements(GamePanel panel) {\n");
